...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2017 at 10:44 PM
...
INSERT INTO `jerseys` (`id`, `league`, `design`, `price`, `team`, `players`, `image`, `details`) VALUES
(1, 'New', 'Reebok', 60.55, 'Liverpool', ' Mellor, Cisse, Hyypia, Crouch, Carragher', 'Images/Jersey/jersey1.jpg', 'Rare Champions League home shirt as worn when the holders progressed from the group stages as winners, but were knocked out by Benfica in the last 16, losing 3-0 on aggregate.'),
...
(1, 'Siim', 'Salu', 'Admin', '1234'),
(10, 'Simon', 'Young', 'Simon', '1234'),
(11, 'Siim', 'Salu', 'abc', 'asd');
